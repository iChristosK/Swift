//Import UI Kit in order to import the User Interface Kit

/*
import UIKit

// var str = "Swift Playgrounds"
var str = "Swift Playgrounds"
print("Swift") //Prints hello world
print("Completed")
...
let expicitFloat: Float = 4.0
let label = "The width is"
let width = 94

// error here let widthLabel = width + String(label)

let apples = 3
let oranges = 5

// with  \(var)
// you include values in strings
...
//shoppingList[0] is like arrays in c that 0 is the first element of the array


//Table of occupations, this is like a struct
...
shoppingList.append("blue paint") // .append("string" to add to an array

print(shoppingList) // prints entire array in the screen

let ArrayEmpty = [String]() // initialize empty array
print(ArrayEmpty) // print empty array
...
//Now create an array of grades and find the grades that are lower than 50 and add on them till the reach 50


let individualGrades = [45, 59, 34,69 ,98 ,100, 37, 57, 99]
var ok = 0
for grade in individualGrades
{
    if grade > 50
    {
        ok + 1
...
var optionalString: String? = "Expression"
print(optionalString == nil)
// Prints "false"

var optionalName: String? = "nil"
var greeting = "iPhone X"
if let name = optionalName {
    greeting = "Buy the new, \(name)"
}
    else
        {
            //write code here
